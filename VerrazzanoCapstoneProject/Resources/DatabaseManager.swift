...
//
//  Created by Joseph  DeMario on 3/19/22.
//
...
///reads and writes data to Firebase database
...
extension DatabaseManager {
    ...
    ///Fetches and returns conversation
    ...
    ///Gets all messages from conversation
    ...
    ///Sends a message to selected conversation
    ...
    public func deleteConversation(conversationId: String, completion: @escaping (Bool) -> Void) {
        ...
        //Get all conversations for current user -> delete conversations in collection with target id -> reset those conversations for the user in database
